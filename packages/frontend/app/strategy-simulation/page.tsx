      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <nav className="flex items-center gap-8">
            ...
            <Link
              ...
              className="text-lg font-semibold text-blue-600 border-b-2 border-blue-600"
            >
              Strategy Simulation
            </Link>
          </nav>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Strategy Status */}
            <Card
              className={`border-2 ${isProfitable ? "border-green-500 bg-green-50" : "border-blue-500 bg-blue-50"}`}
            >
